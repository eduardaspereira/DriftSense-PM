...
class PipelineOrchestrator:
    ...
    def print_summary(self):
        ...
        # Results location
        print(f"\nResultados em:")
        print(f"   - results/metrics/driftsense_dataset/full_factorial_results.csv")
        print(f"   - results/metrics/driftsense_dataset/full_factorial_summary.csv")
        print(f"   - results/figures/driftsense_dataset/*.png")
        print(f"   - models/driftsense_dataset/baseline_model.pkl")
...
def main():
    ...
    print(f"   [3] Factorial Evaluation")
    print(f"   [4] Statistical Analysis")
    print(f"   [5] Plot Generation")
